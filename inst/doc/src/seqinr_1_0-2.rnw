...
At the compilation time of this document there were \Sexpr{nrow(CRAN.packages())}
...
<<face2face, fig=TRUE, width=16, height=8>>=
...
\setkeys{Gin}{width=\textwidth}
<<K80, fig=TRUE, echo=F, results=hide, width=16, height=8>>=
