...
\begin{itemize}
  ...
  \item Base packages: base, datasets, grDevices, graphics, grid,
    methods, stats, utils
  \item Other packages: MASS~7.2-40, XML~1.93-2, ade4~1.4-5,
    ape~2.1, gee~4.13-13, grImport~0.2-4, lattice~0.17-4,
...
\begin{itemize}
  \item \Rlogo{} compilation time was: Sun Feb 24 09:45:44 2008
