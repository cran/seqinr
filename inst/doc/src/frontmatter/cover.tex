...
\begin{itemize}
  ...
  \item Base packages: base, datasets, grDevices, graphics, grid,
    methods, stats, utils
  \item Other packages: MASS~7.2-42, XML~1.95-3, ade4~1.4-9,
    ape~2.2-1, grImport~0.2-4, nlme~3.1-89, quadprog~1.4-11,
    seqinr~1.1-7, tseries~0.10-15, xtable~1.5-2, zoo~1.5-4
  \item Loaded via a namespace (and not attached): lattice~0.17-8,
    tools~2.7.1
\end{itemize}
There were two compilation steps:

\begin{itemize}
  \item \Rlogo{} compilation time was: Mon Jul 28 11:19:28 2008
